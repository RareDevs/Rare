...
class LibraryHeadBar(QWidget):
    ...
    def __init__(self, settings: RareAppSettings, rcore: RareCore, parent=None):
        ...
        middle_layout.addWidget(self.installed_icon)
        middle_layout.addWidget(self.installed_label)
        middle_layout.addWidget(self.available_icon)
        middle_layout.addWidget(self.available_label)
