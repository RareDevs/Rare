...
class Ui_About(object):
    def setupUi(self, About):
        ...
        self.gridLayout.addWidget(self.lbl_version, 2, 0, 1, 1, QtCore.Qt.AlignRight)
        ...
        self.lbl_update = QtWidgets.QLabel(About)
        self.lbl_update.setObjectName("lbl_update")
        self.gridLayout.addWidget(self.lbl_update, 3, 0, 1, 1, QtCore.Qt.AlignRight)
        self.version = QtWidgets.QLabel(About)
        self.version.setObjectName("version")
        self.gridLayout.addWidget(self.version, 2, 1, 1, 1)
        self.lbl_dev = QtWidgets.QLabel(About)
        self.lbl_dev.setObjectName("lbl_dev")
        self.gridLayout.addWidget(self.lbl_dev, 5, 0, 1, 1, QtCore.Qt.AlignRight)
    ...
    def retranslateUi(self, About):
        ...
        self.lbl_version.setText(_translate("About", "Version:"))
        self.lbl_license.setText(_translate("About", "License:"))
        self.lbl_lgd_dev.setText(_translate("About", "Legendary Developer:"))
        self.dev.setToolTip(_translate("About", "Github"))
        self.dev.setText(_translate("About", "<a href=\'https://github.com/Dummerle\'>Dummerle</a>"))
        self.lbl_update.setText(_translate("About", "Update available:"))
        self.version.setText(_translate("About", "version"))
        self.lbl_dev.setText(_translate("About", "Rare Developer:"))
