...
class ScrollAreaTabContents:
    # str: title
    set_title = Signal(str)
    implements_scrollarea: bool = False


class ScrollAreaTabContentsProtocol(Protocol):
    ...
    @abstractmethod
    def setSizePolicy(self, hpolicy: QSizePolicy.Policy, vpolicy: QSizePolicy.Policy) -> None:
        pass


class ScrollAreaTabContainer(QWidget):
    def __init__(
        self,
        widget: QWidget | ScrollAreaTabContentsProtocol,
        title: str = '',
        *,
        parent: QWidget | None = None,
    ):
        super(ScrollAreaTabContainer, self).__init__(parent=parent)
...
class ScrollAreaTabWidget(QTabWidget):
    backClicked = Signal()
    ...
    def __init__(
        ...
        *,
        ...
        super(ScrollAreaTabWidget, self).__init__(parent=parent)
        self.setDocumentMode(True)
        if show_back:
            super().addTab(QWidget(self), qta_icon('mdi.keyboard-backspace', 'ei.backward'), self.tr('Back'))
    ...
    def addTab(self, widget: QWidget, a1: str, title: str = '') -> int:
        container = ScrollAreaTabContainer(widget, title, parent=self)
        return super(ScrollAreaTabWidget, self).addTab(container, a1)
...
class SideTabWidget(ScrollAreaTabWidget):
    def __init__(
        self,
        *,
        show_back: bool = False,
