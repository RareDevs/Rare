...
class Ui_GameDlc(object):
    def setupUi(self, GameDlc):
        ...
        sizePolicy.setHeightForWidth(
            self.installed_dlc_group.sizePolicy().hasHeightForWidth()
        )
        self.installed_dlc_group.setSizePolicy(sizePolicy)
        self.installed_dlc_group.setAlignment(
            QtCore.Qt.AlignLeading | QtCore.Qt.AlignLeft | QtCore.Qt.AlignTop
        )
        self.installed_dlc_group.setObjectName("installed_dlc_group")
        self.installed_dlc_group_layout = QtWidgets.QVBoxLayout(
            self.installed_dlc_group
        )
        ...
        self.installed_dlc_scroll.setHorizontalScrollBarPolicy(
            QtCore.Qt.ScrollBarAlwaysOff
        )
        self.installed_dlc_scroll.setWidgetResizable(True)
        self.installed_dlc_scroll.setAlignment(
            QtCore.Qt.AlignLeading | QtCore.Qt.AlignLeft | QtCore.Qt.AlignTop
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.installed_dlc_contents.sizePolicy().hasHeightForWidth()
        )
        self.installed_dlc_contents.setSizePolicy(sizePolicy)
        self.installed_dlc_contents.setObjectName("installed_dlc_contents")
        self.installed_dlc_contents_layout = QtWidgets.QVBoxLayout(
            self.installed_dlc_contents
        )
        self.installed_dlc_contents_layout.setContentsMargins(0, 0, 9, 0)
        self.installed_dlc_contents_layout.setObjectName(
            "installed_dlc_contents_layout"
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.available_dlc_group.sizePolicy().hasHeightForWidth()
        )
        self.available_dlc_group.setSizePolicy(sizePolicy)
        self.available_dlc_group.setAlignment(
            QtCore.Qt.AlignLeading | QtCore.Qt.AlignLeft | QtCore.Qt.AlignTop
        )
        self.available_dlc_group.setObjectName("available_dlc_group")
        self.available_dlc_group_layout = QtWidgets.QVBoxLayout(
            self.available_dlc_group
        )
        ...
        self.available_dlc_scroll.setHorizontalScrollBarPolicy(
            QtCore.Qt.ScrollBarAlwaysOff
        )
        self.available_dlc_scroll.setWidgetResizable(True)
        self.available_dlc_scroll.setAlignment(
            QtCore.Qt.AlignLeading | QtCore.Qt.AlignLeft | QtCore.Qt.AlignTop
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.available_dlc_contents.sizePolicy().hasHeightForWidth()
        )
        self.available_dlc_contents.setSizePolicy(sizePolicy)
        self.available_dlc_contents.setObjectName("available_dlc_contents")
        self.available_dlc_contents_layout = QtWidgets.QVBoxLayout(
            self.available_dlc_contents
        )
        self.available_dlc_contents_layout.setContentsMargins(0, 0, 9, 0)
        self.available_dlc_contents_layout.setObjectName(
            "available_dlc_contents_layout"
        )
    ...
    def retranslateUi(self, GameDlc):
        ...
        self.installed_dlc_label.setText(
            _translate("GameDlc", "No Downloadable Content has been installed.")
        )
        self.available_dlc_group.setTitle(_translate("GameDlc", "Available DLCs"))
        self.available_dlc_label.setText(
            _translate("GameDlc", "No Downloadable Content is available")
        )
