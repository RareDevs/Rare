...
class Ui_DiscordRPCSettings:
    def setupUi(self, DiscordRPCSettings):
        ...
        self.os_check.setObjectName("os_check")
    ...
    def retranslateUi(self, DiscordRPCSettings):
        DiscordRPCSettings.setTitle(QCoreApplication.translate("DiscordRPCSettings", "Discord RPC", None))
        self.label.setText(QCoreApplication.translate("DiscordRPCSettings", "Show", None))
        self.game_check.setText(QCoreApplication.translate("DiscordRPCSettings", "Show game", None))
        self.os_check.setText(QCoreApplication.translate("DiscordRPCSettings", "Show OS", None))
        self.time_check.setText(QCoreApplication.translate("DiscordRPCSettings", "Show play time", None))
    # retranslateUi
