...
class Ui_shop_info(object):
    def setupUi(self, shop_info):
        ...
        self.price.setText("")
        self.price.setTextInteractionFlags(
            QtCore.Qt.LinksAccessibleByMouse | QtCore.Qt.TextSelectableByMouse
        )
        ...
        sizePolicy.setHeightForWidth(
            self.open_store_button.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.wishlist_button.sizePolicy().hasHeightForWidth()
        )
    ...
    def retranslateUi(self, shop_info):
        ...
        self.open_store_button.setText(
            _translate("shop_info", "Buy Game in Epic Games Store")
        )
