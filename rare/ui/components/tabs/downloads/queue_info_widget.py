...
class Ui_QueueInfoWidget:
    ...
    def retranslateUi(self, QueueInfoWidget):
        self.dl_size_label.setText(QCoreApplication.translate("QueueInfoWidget", "Download size", None))
        self.local_version_label.setText(QCoreApplication.translate("QueueInfoWidget", "Local version", None))
        self.install_size_label.setText(QCoreApplication.translate("QueueInfoWidget", "Installed size", None))
        self.remote_version_label.setText(QCoreApplication.translate("QueueInfoWidget", "Remote version", None))
    # retranslateUi
