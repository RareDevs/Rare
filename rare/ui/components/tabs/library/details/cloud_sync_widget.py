...
class Ui_CloudSyncWidget:
    ...
    def retranslateUi(self, CloudSyncWidget):
        self.local_group.setTitle(QCoreApplication.translate("CloudSyncWidget", "Local", None))
        self.age_label_local.setText("")
        self.upload_button.setText(QCoreApplication.translate("CloudSyncWidget", "Upload", None))
        self.cloud_group.setTitle(QCoreApplication.translate("CloudSyncWidget", "Cloud", None))
        self.download_button.setText(QCoreApplication.translate("CloudSyncWidget", "Download", None))
    # retranslateUi
