...
class Ui_InstallDialog(object):
    def setupUi(self, InstallDialog):
        ...
        self.install_dialog_layout.setWidget(
            0, QtWidgets.QFormLayout.SpanningRole, self.install_dialog_label
        )
        self.install_dir_label = QtWidgets.QLabel(InstallDialog)
        self.install_dir_label.setObjectName("install_dir_label")
        self.install_dialog_layout.setWidget(
            1, QtWidgets.QFormLayout.LabelRole, self.install_dir_label
        )
        ...
        self.install_dialog_layout.setLayout(
            1, QtWidgets.QFormLayout.FieldRole, self.install_dir_layout
        )
        self.max_workers_label = QtWidgets.QLabel(InstallDialog)
        self.max_workers_label.setObjectName("max_workers_label")
        self.install_dialog_layout.setWidget(
            2, QtWidgets.QFormLayout.LabelRole, self.max_workers_label
        )
        ...
        sizePolicy.setHeightForWidth(
            self.max_workers_spin.sizePolicy().hasHeightForWidth()
        )
        ...
        self.install_dialog_layout.setLayout(
            2, QtWidgets.QFormLayout.FieldRole, self.max_workers_layout
        )
        self.force_download_label = QtWidgets.QLabel(InstallDialog)
        self.force_download_label.setObjectName("force_download_label")
        self.install_dialog_layout.setWidget(
            3, QtWidgets.QFormLayout.LabelRole, self.force_download_label
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.ignore_space_check.sizePolicy().hasHeightForWidth()
        )
        ...
        self.install_dialog_layout.setLayout(
            5, QtWidgets.QFormLayout.FieldRole, self.ignore_space_layout
        )
        self.download_only_label = QtWidgets.QLabel(InstallDialog)
        self.download_only_label.setObjectName("download_only_label")
        self.install_dialog_layout.setWidget(
            6, QtWidgets.QFormLayout.LabelRole, self.download_only_label
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.download_only_check.sizePolicy().hasHeightForWidth()
        )
        ...
        self.install_dialog_layout.setLayout(
            6, QtWidgets.QFormLayout.FieldRole, self.download_only_layout
        )
        self.sdl_list_label = QtWidgets.QLabel(InstallDialog)
        self.sdl_list_label.setObjectName("sdl_list_label")
        self.install_dialog_layout.setWidget(
            7, QtWidgets.QFormLayout.LabelRole, self.sdl_list_label
        )
        ...
        self.install_dialog_layout.setWidget(
            8, QtWidgets.QFormLayout.FieldRole, self.download_size_info_label
        )
        self.install_size_label = QtWidgets.QLabel(InstallDialog)
        self.install_size_label.setObjectName("install_size_label")
        self.install_dialog_layout.setWidget(
            9, QtWidgets.QFormLayout.LabelRole, self.install_size_label
        )
        ...
        self.install_dialog_layout.setWidget(
            9, QtWidgets.QFormLayout.FieldRole, self.install_size_info_label
        )
        self.warn_label = QtWidgets.QLabel(InstallDialog)
        self.warn_label.setObjectName("warn_label")
        self.install_dialog_layout.setWidget(
            10, QtWidgets.QFormLayout.LabelRole, self.warn_label
        )
        ...
        self.install_dialog_layout.setWidget(
            10, QtWidgets.QFormLayout.FieldRole, self.warn_message
        )
    ...
    def retranslateUi(self, InstallDialog):
        ...
        self.max_workers_info_label.setText(
            _translate("InstallDialog", "Less is slower. (0: Default)")
        )
        self.force_download_label.setText(
            _translate("InstallDialog", "Force redownload")
        )
        self.ignore_space_label.setText(
            _translate("InstallDialog", "Ignore free space")
        )
        self.ignore_space_info_label.setText(
            _translate("InstallDialog", "Use with caution!")
        )
        self.download_only_label.setText(_translate("InstallDialog", "Download only"))
        self.download_only_info_label.setText(
            _translate("InstallDialog", "Do not try to install.")
        )
        ...
        self.download_size_info_label.setText(
            _translate("InstallDialog", "Click verify...")
        )
        self.install_size_label.setText(
            _translate("InstallDialog", "Total install size")
        )
